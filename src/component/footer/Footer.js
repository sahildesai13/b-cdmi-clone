  ...
  return (
    <footer className='pt-5'>
      <div className='container '>
        <div className='footerContainer pt-5 plr-100 ptb-50'>
          <div className='footerGrid d-grid auto3 ptb-50'>
            <div className='cdmiDtl '>
              ...
              <div className='cdmiText'>
                ...
                <span className='text-start'>FOLLOW US ON </span>
              </div>
            ...
            <div className='cdmiLink text-start'>
              <div className='cdmiHead text-start'>
                <h5 className='ps-4'>FEATURE LINK</h5>
              </div>
